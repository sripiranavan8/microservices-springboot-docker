...
public class CurrencyConversionController {
	...
	public CurrencyConversion retriveConversionValues(@PathVariable String from, @PathVariable String to,
	...
	public CurrencyConversion retriveConversionValuesFeign(@PathVariable String from, @PathVariable String to,
			@PathVariable BigDecimal quantity) {
